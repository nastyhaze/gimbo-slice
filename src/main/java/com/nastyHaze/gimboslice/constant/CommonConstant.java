...
public class CommonConstant {
    ...
    public static final String INVALID_ARGUMENTS_ERROR_MESSAGE = "Issue with command arguments. Try checking your arguments ***N E R D***. \n:weary: \\:disaster: \\:lookofdisdain:";
